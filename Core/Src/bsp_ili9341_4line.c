...
**********************************************************************
* @fun     :ILI9341_Sleep
* @brief   :显示屏休眠 (Display OFF + Sleep IN)
* @param   :
* @return  :None
**********************************************************************
*/
...
{
	/* 背光交由 backlight_service (软件PWM) 管理, 此处只控制显示控制器 */
	ILI9341_WR_REG(0x28);  // Display OFF
	ILI9341_WR_REG(0x10);  // Sleep IN
}

/*
**********************************************************************
* @fun     :ILI9341_Wake
* @brief   :显示屏唤醒 (Sleep OUT + Display ON)
* @param   :
* @return  :None
**********************************************************************
*/
